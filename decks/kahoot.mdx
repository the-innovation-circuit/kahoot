...
- Your bot is simply guessing should get 2/10 questions correct if you answer the first answer.
- You'll need to change `000000` to `08474619`.
...
# Time for another test run: 07056161! Good luck!
...
<Text sx={{ color: 'purple', textShadow: '0 0 12px currentColor', fontSize: 10, fontWeight: 'bold' }}>Final Round: 06654377!</Text>
